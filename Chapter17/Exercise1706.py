...
class Time(object):
    ...
    def __init__(self, hour=0, minute=0, second=0):
        ...
        self.seconds_since_midnight = minutes * 60 + second

    def __str__(self):
    	minutes, second = divmod(self.seconds_since_midnight, 60)
    ...
    def add_time(self, other):
        ...
        seconds = self.seconds_since_midnight + other.seconds_since_midnight
    ...
    def is_valid(self):
        ...
        # num of seconds is positive and not greater than one day's worth of seconds
        return self.seconds_since_midnight >= 0 and self.seconds_since_midnight < (24*60*60)
